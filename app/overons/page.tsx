...
const Page = () => {
  return (
    <div className="relative min-h-screen bg-[#EDBCA4] grid grid-cols-1 lg:grid-cols-2 items-start p-4 lg:p-6 gap-2 rounded-md lg:grid-rows-[380px_minmax(400px,0.8fr)_10px] ">
